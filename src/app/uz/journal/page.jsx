            ...
            <nav style={{ display: 'none' }} className="bg-white shadow-sm h-16 fixed w-full top-0 z-50">
                <div className="max-w-screen-xl mx-auto h-full px-4 md:px-8 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xl font-semibold text-gray-900">GTFJ</span>
                    </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between">
                            ...
                            <div className="relative z-10 w-full md:w-1/2 mb-8 md:mb-0">
                                ...
                                <p className="text-lg md:text-xl text-gray-600 max-w-2xl mt-6">
                                    Bizning jurnal gumanitar va tabiiy fanlar sohasidagi tadqiqotlar va yutuqlarni birlashtirib, fikr almashish, ilmiy munozaralar va yangi kontseptsiyalarni taqdim etish uchun platforma taqdim etadi.
                                </p>
                            ...
                            >
                                <div className="relative bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 transform group-hover:-translate-y-2">
                                    <div className="aspect-w-3 aspect-h-4">
                                        <img
                                            src="https://emuni.uz/wp-content/uploads/2023/06/image_2023-06-14_10-55-50.png"
                                            alt={`Jurnal muqovasi ${journal.year} №${journal.number}`}
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-4 md:p-6 text-white">
                                        <h3 className="text-base md:text-lg font-bold mb-3">
                                            GUMANITAR VA TABIIY FANLAR JURNALI
                                        </h3>
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button className="flex items-center space-x-2 bg-white/20 backdrop-blur-sm px-3 md:px-4 py-1.5 md:py-2 rounded-full hover:bg-white/30 transition-colors duration-200">
                                                ...
                                                <span className="text-xs md:text-sm font-medium">Yuklab olish</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="w-full md:w-2/3 space-y-4 md:space-y-6">
                            <div className="bg-white rounded-xl p-4 md:p-6 hover:shadow-lg transition-all">
                                <div className="flex items-start justify-between">
                                    <div>
                                        <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Jurnal rahbariyati</h4>
                                        <p className="text-sm md:text-base text-gray-600">Jurnalning strategik yo'nalishini belgilaydigan, uning ilmiy siyosatini shakllantiradigan va nashrlarning yuqori sifatini ta'minlaydigan hurmatli kengash a'zolari bilan tanishing. Ularning tajribasi va bilimlari fanlararo tadqiqotlarni rivojlantirishga va akademik standartlarni qo'llab-quvvatlashga yordam beradi.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl p-4 md:p-6 hover:shadow-lg transition-all">
                                <div className="flex items-start justify-between">
                                    <div>
                                        <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Xalqaro ekspertlar</h4>
                                        <p className="text-sm md:text-base text-gray-600">Jurnalimiz turli mamlakatlardan kelgan ekspertlar va tahririyat a'zolarini o'z ichiga olgan global tarmoq bilan faxrlanadi. Ular ilmiy maqolalarni xolis va sifatli tanlashda muhim rol o'ynaydi, shuningdek, xalqaro bilim almashinuviga va eng yaxshi amaliyotlarga hissa qo'shadi.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl p-4 md:p-6 hover:shadow-lg transition-all">
                                <div className="flex items-start justify-between">
                                    <div>
                                        <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Hududiy vakillar</h4>
                                        <p className="text-sm md:text-base text-gray-600">Bizning mahalliy ekspertlarimiz jurnalni hududiy darajada rivojlantirishga yordam beradi, mualliflarni jalb qiladi, ilmiy jamoatni qo'llab-quvvatlaydi va global ilmiy yutuqlarni mahalliy sharoitlarga moslashtiradi. Ularning hissasi tadqiqotchilar o'rtasidagi aloqalarni mustahkamlashga va akademik muloqotni kengaytirishga yordam beradi.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                        <div className="text-center mb-8 md:mb-12">
                            ...
                            <p className="text-gray-600 max-w-3xl mx-auto text-sm md:text-base">
                                Gumanitar va tabiiy fanlar jurnalida nashr qilish uchun mualliflar quyidagi talablarga rioya qilishlari kerak:
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mb-8 md:mb-12">
                            <div className="bg-white rounded-xl p-4 md:p-6 shadow-md hover:shadow-lg transition-shadow">
                                <div className="flex items-center space-x-4 mb-4">
                                    ...
                                    <h3 className="text-lg md:text-xl font-bold text-gray-900">Maqola tuzilishi</h3>
                                </div>
                                <div className="text-sm md:text-base text-gray-600">
                                    <ul>
                                        <li>UDK kodi (agar mavjud bo'lsa).</li>
                                        <li>Maqola sarlavhasi va annotatsiyasi rus, o'zbek va ingliz tillarida.</li>
                                        <li>Mualliflarning F.I.O., ilmiy darajasi, ilmiy unvoni, ish bajarilgan tashkilot nomi (rus, o'zbek va ingliz tillarida).</li>
                                        <li>Ilmiy rahbarning F.I.O. (agar mavjud bo'lsa).</li>
                                        <li>Tahririyat bilan aloqa uchun kontakt ma'lumotlari (e-mail, telefon).</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl p-4 md:p-6 shadow-md hover:shadow-lg transition-shadow">
                                <div className="flex items-center space-x-4 mb-4">
                                    ...
                                    <h3 className="text-lg md:text-xl font-bold text-gray-900">Manbalar va iqtiboslarga qo'yiladigan talablar</h3>
                                </div>
                                <p className="text-sm md:text-base text-gray-600">
                                    Adabiyotlar ro'yxati alifbo tartibida tuziladi: avval mahalliy manbalar, keyin xorijiy manbalar.<br />
                                    Barcha iqtiboslar raqamlangan bo'lishi va matndagi tartibiga mos kelishi kerak.<br />
                                    Nashr qilinmagan ishlarga iqtibos keltirish taqiqlanadi.<br />
                                    Muallif bibliografiyaning to'g'riligidan javobgardir.<br />
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-xl p-4 md:p-6 shadow-md hover:shadow-lg transition-shadow">
                                <div className="flex items-center space-x-4 mb-4">
                                    ...
                                    <h3 className="text-lg md:text-xl font-bold text-gray-900">Rasm va jadvallar</h3>
                                </div>
                                <p className="text-sm md:text-base text-gray-600">
                                    Rasmlar matnga kiritiladi, ularning raqami tasvir ostida ko'rsatiladi.<br />
                                    Grafiklar va diagrammalar matn bilan ortiqcha yuklanmasligi kerak.<br />
                                    Fotosuratlar va chizmalar faqat oq-qora formatda.<br />
                                    Jadvallar ixcham, aniq va matndagi ma'lumotlarga to'liq mos kelishi kerak.<br />
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-6">
                            <button className="inline-flex items-center justify-center px-6 py-3 bg-[#5f1464] text-white rounded-full hover:bg-opacity-90 transition-colors">
                                ...
                                <span className="text-sm md:text-base">Yuklab olish</span>
                            </button>
                            <button className="inline-flex items-center justify-center px-6 py-3 border-2 border-[#5f1464] text-[#5f1464] rounded-full hover:bg-[#5f1464] hover:text-white transition-colors">
                                ...
                                <span className="text-sm md:text-base">Onlayn ko'rish</span>
                            </button>
                        </div>
                    </div>
                </div>

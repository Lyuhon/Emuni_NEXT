    ...
    const videoTestimonials = [
        {
            id: 1,
            name: 'Анна',
            image: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/peARIAZn52Q.webp',
            videoId: 'peARIAZn52Q',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/peariazn52q.webp',
        },
        {
            id: 2,
            name: 'Александр',
            image: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/eu13rpcz-5m.webp',
            videoId: 'Eu13rpCz-5M',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/eu13rpcz-5m.webp',
        },
        {
            id: 3,
            name: 'Михаил',
            image: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/rdbc8r8a2w4.webp',
            videoId: 'rDbc8R8A2w4',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/rdbc8r8a2w4.webp',
        },
        {
            id: 4,
            name: 'Дмитрий',
            ...
            videoId: 'AAh70DykwkU',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/aah70dykwku.jpg',
        },
        {
            id: 5,
            name: 'Елена',
            image: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/3aytmupj-eq.webp',
            videoId: '3AYTMUpj-EQ',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/3aytmupj-eq.webp',
        },
        {
            id: 6,
            name: 'Елена',
            image: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/03/emu_gold_logo.jpg',
            videoId: 'xqkN10JxC6s',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/xqkn10jxc6s.jpg',
        },
        {
            id: 7,
            name: 'Елена',
            image: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/i6bakr1a8mc.webp',
            videoId: 'i6bAkr1A8Mc',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/i6bakr1a8mc.webp',
        },
        {
            id: 8,
            name: 'Елена',
            image: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/a1pt1t8fwq4.webp',
            videoId: 'A1pt1t8Fwq4',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/a1pt1t8fwq4.webp',
        },
        {
            id: 9,
            name: 'Елена',
            image: 'https://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/zwz2p7nmzqs.webp',
            videoId: 'zwZ2P7nmzQs',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/zwz2p7nmzqs.webp',
        },
        {
            id: 10,
            name: 'Елена',
            image: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/43rol-3ugfm.webp',
            videoId: '43ROl-3UgfM',
            thumbnailImage: 'http://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/43rol-3ugfm.webp',
        },
    ];
        ...
        <section className="py-16 pb-8 md:py-24 bg-white md:pb-[0]">
            <div className="max-w-screen-xl mx-auto px-4">
                ...
                >
                    ...
                    <p className="hidden text-gray-600 max-w-3xl mx-auto text-sm md:text-base">
                    </p>
                </motion.div>

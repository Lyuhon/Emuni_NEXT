        ...
        <section className="py-20 px-4 relative overflow-hidden">
            ...
            <div className="max-w-screen-xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
                    ...
                    >
                        <h6 className="text-[#631463] font-semibold mb-3 uppercase tracking-wider text-sm">EMU Universiteti Statistikasi</h6>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 leading-tight mb-8">
                            Akademik<br />mukammallik<br />
                            <span className="text-[#631463]">global nuqtai nazar bilan</span>
                        </h2>
                    </motion.div>
                    ...
                    >
                        ...
                        <Counter
                            target="51"
                            suffix="%"
                            title="Professor-o‘qituvchilar tarkibining ilmiy daraja darajasi"
                            icon={
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#631463]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <Counter
                            target="98"
                            suffix="%"
                            title="Talabalarning qoniqish darajasi"
                            icon={
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#631463]" fill="none" viewBox="0 0 24 24" stroke="currentColor">

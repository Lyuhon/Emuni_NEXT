...
export const metadata = {
    ...
    description: "EMU University Toshkentdagi qabul, ta’lim dasturlari, narxlar va bitiruvchilarning imkoniyatlari haqida tez-tez so‘raladigan savollarga javoblar oling.",
    keywords: "EMU University FAQ, universitet haqida savollar, EMUga qabul, Toshkentda ta’lim, EMU savol-javoblar",
    openGraph: {
        title: "Ko‘p so‘raladigan savollar - EMU University",
        description: "EMU Universitydagi qabul, ta’lim va bitiruvchilarning imkoniyatlari haqida eng ko‘p beriladigan savollarga javoblar",
            ...
            <div className="max-w-screen-xl mx-auto px-6 py-12">
                ...
                <script type="application/ld+json" dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "JobPosting",
                        "title": "EMU University o'qituvchisi",
                        "description": "EMU University yetakchi tibbiyot universitetining jamoasiga qo'shilishga iste'dodli o'qituvchilarni taklif qiladi.",

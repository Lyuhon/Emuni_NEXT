                        ...
                        {partnersData.map((slideItem, slideIndex) => (
                            <SwiperSlide key={slideIndex}>
                                <div className="partners-card bg-white rounded-2xl shadow-lg overflow-hidden">
                                    <div className="p-4 md:p-6">
                                        <div className="grid grid-cols-1 gap-4 md:gap-6">
                                            {slideItem.name_uz_1 && renderPartnerItem(slideItem.name_uz_1, slideItem.partner_1, slideItem.link_1, 'partner1')}
                                            {slideItem.name_uz_2 && renderPartnerItem(slideItem.name_uz_2, slideItem.partner_2, slideItem.link_2, 'partner2')}
                                            {slideItem.name_uz_3 && renderPartnerItem(slideItem.name_uz_3, slideItem.partner_3, slideItem.link_3, 'partner3')}
                                        </div>
                                    </div>
                                </div>
                            </SwiperSlide>

...
export const metadata = {
    title: "Universitet kampuslari | EMU University",
    description: "Toshkentdagi EMU University kampuslari haqida ma'lumot - Business and Social School Campus va Medical School Campus. Infratuzilma, joylashuv va talabalar uchun qulayliklar.",
    keywords: "kampuslar, EMU University, biznes-kampus, tibbiyot kampusi, joylashuv, infratuzilma, universitet toshkent",
    openGraph: {
        title: "Toshkentdagi EMU University kampuslari",
        description: "Talabalarning qulay ta'lim olishi va har tomonlama rivojlanishi uchun yaratilgan zamonaviy ta'lim joylari",
...
const structuredData = {
    ...
    "name": "EMU University",
    "description": "Toshkentda ikkita zamonaviy kampusga ega bo'lgan universitet",
    "address": {
        "@type": "PostalAddress",
    ...
    const campuses = [
        {
            ...
            description: acfData.opisanie_business_kampusa_uz,
            location: acfData.adres_business_kampusa_uz,
            ...
            facilities: acfData.infrastruktura_business_kampusa_uz.map(item => item.nazvanie)
        },
        {
            id: "medical",
            title: "Medical School Campus",
            images: acfData.slajder_medical_kampusa.map(item => item.izobrazhenie.url),
            description: acfData.opisanie_medical_kampusa_uz,
            location: acfData.adres_medical_kampusa_uz,
            phone: "+998(78) 147-00-07", // You may want to add a phone field to your API
            ...
            facilities: acfData.infrastruktura_medical_kampusa_uz.map(item => item.nazvanie)
        },
    ];

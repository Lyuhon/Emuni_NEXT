...
export const metadata = {
    title: "Aloqa - EMU University",
    description: "EMU University bilan bog‘laning: aloqa ma’lumotlari, manzillar, telefonlar va yo‘l xaritasi. Toshkentdagi bosh kampusimiz yoki tibbiyot maktabimizga tashrif buyuring.",
    keywords: "EMU University aloqa, universitet manzili, EMU telefoni, yo‘l xaritasi, Toshkent tibbiyot universiteti",
    openGraph: {
        title: "Aloqa - EMU University",
        description: "EMU University bilan bog‘laning: aloqa ma’lumotlari, manzillar, telefonlar va yo‘l xaritasi. Toshkentdagi bosh kampusimiz yoki tibbiyot maktabimizga tashrif buyuring.",
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <script type="application/ld+json" dangerouslySetInnerHTML={{
                __html: JSON.stringify({
                    ...
                    "description": "EMU University — Toshkentdagi yetakchi ko‘p yo‘nalishli universitet",

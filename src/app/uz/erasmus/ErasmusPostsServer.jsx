...
export default function ErasmusPostsServer({ postsData, brandColors }) {
    ...
    const posts = postsData?.posts?.map((post) => ({
        ...
        categoryName: decodeHTMLEntities(post.category?.name) || 'Kategoriya yo‘q',
            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-8">
                ...
                <div className="relative text-center mb-8 md:mb-12">
                    ...
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        EMU University’dagi Erasmus+ xalqaro ta’lim dasturining so‘nggi yangiliklari va voqealari
                    </p>
                </div>
                ...
                {posts.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="mt-2 text-gray-500">
                            “erasmus” tegi bilan hali postlar qo‘shilmagan.{' '}
                            <Link href="/blog" className="underline" style={{ color: brandColor }}>

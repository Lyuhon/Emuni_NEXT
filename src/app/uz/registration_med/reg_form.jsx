...
//                                         {message && !isSubmitted && (
//                                             <motion.p
//                                                 className={`mt-4 text-center font-medium ${message.includes('muvaffaqiyatli') ? 'text-green-600' : 'text-red-600'}`}
//                                                 initial={{ opacity: 0, y: 10 }}
//                                                 animate={{ opacity: 1, y: 0 }}
//                                             >
//                                                 {message}
...
// uz/reg_form.jsx - Улучшенная версия
...
export default function RegistrationForm() {
    ...
    useEffect(() => {
        ...
        formData[fields.find(f => f.label === `Qo'shimcha telefon raqam`)?.id],
        fields.length
    ]);
    ...
    const handleSubmit = async (e) => {
        ...
        setIsSubmitting(true);
        console.log('Yuborilayotgan ma\'lumotlar:', JSON.stringify({ form_id: submitFormId, fields: formData }));

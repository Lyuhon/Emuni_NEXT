...
export default function Popup({ isOpen, onClose }) {
    ...
    const mappingMed = {
        ...
        'Болалар терапевтик стоматологияси': 'Детская терапевтическая стоматология | Болалар терапевтик стоматологияси',
        'Жарроҳлик стоматология': 'Хирургическая стоматология | Жарроҳлик стоматология',
        'Болалар жарроҳлик стоматологияси': 'Детская хирургическая стоматология | Болалар жарроҳлик стоматологияси',
    };
                ...
                >
                    ...
                    >
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-2xl font-bold text-gray-800">Magistratura EMU University</h2>

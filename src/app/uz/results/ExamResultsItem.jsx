            ...
            >
                ...
                <div className="flex items-center gap-3 ml-4">
                    <div className="bg-[#6b0e55] hover:bg-[#8b1e6b] text-white px-4 py-2 rounded-lg transition-all duration-200 flex items-center gap-2">
                        ...
                        {!isMobile && isOpen ? 'Yashirish' : 'Ko\'rish'}
                    </div>
                </div>
            </button>
                ...
                <div className="border-t border-gray-200">
                    ...
                    <div className="p-4 bg-gray-50 border-b border-gray-200">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div className="flex items-center gap-2 text-sm text-gray-600">
                                ...
                                <span>Hujjatda qidirish uchun Ctrl+F dan foydalaning</span>
                            </div>
                    ...
                    {isLoading && (
                        <div className="p-8 bg-gray-100 flex flex-col items-center justify-center">
                            ...
                            <p className="text-gray-600 text-sm">Hujjat yuklanmoqda...</p>
                        </div>
                    )}
                        ...
                        {iframeError && (
                            <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h4 className="text-yellow-800 font-medium">PDF ko'rsatilmayaptimi?</h4>
                                        <p className="text-yellow-700 text-sm mt-1">
                                            Ko'rish uchun <button onClick={handleDownload} className="underline hover:no-underline">faylni yuklab oling</button> yoki
                                            <button onClick={() => window.open(pdfUrl, '_blank')} className="underline hover:no-underline ml-1">yangi oynada oching</button>.
                                        </p>
                                    </div>
                                </div>
                            </div>

                ...
                <div className="max-w-screen-xl mx-auto relative z-10">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            EMU talabalari ekologik loyihalar va tashabbuslarda faol ishtirok etadilar
                        </p>
                    </div>
                                ...
                                <div className="relative overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-green-900/80 via-green-900/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                                        <div className="text-white flex items-center">
                                            ...
                                            <span className="font-medium">Ochiq</span>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
                ...
                {lightboxOpen && galleryData.izobrazheniya && (
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Кнопка закрытия */}
                            <button
                                // className="absolute top-4 right-4 w-12 h-12 rounded-full bg-green-600 hover:bg-green-700 text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg"

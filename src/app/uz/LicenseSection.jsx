                ...
                <div className="flex flex-col md:flex-row-reverse items-stretch gap-8 md:gap-12">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 leading-tight">
                            Litsenziyalangan <br />ta'limdagi<br />ustunlik
                        </h2>

                        <div className="space-y-6 text-white/90 text-lg">
                            <p>
                                EMU Universiteti xususiy ta'lim xizmatlarini ko'rsatish uchun rasman litsenziyalangan. Oliy ta'lim fan va innovatsiyalar Vazirligi tomonidan taqdim etilgan 337775 raqamli litsenziya asosidafaoliyat olib boradi.
                            </p>

                            <p>
                                Ushbu litsenziya EMU University o'z talabalariga ajoyib ta'lim tajribasini taqdim etish uchun zarur bo'lgan keng qamrovli o'quv dasturi, o'qituvchilar tarkibi va ta'lim amaliyotlari mos kelishini kafolatlaydi.
                            </p>
                        </div>

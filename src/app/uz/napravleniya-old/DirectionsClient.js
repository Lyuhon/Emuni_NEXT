...
export default function DirectionsClient({ directions, directionContent, acf }) {
    ...
    console.log("Komponent render qilinmoqda:");
    ...
    if (typeof acf === 'string') {
        try {
            acf = JSON.parse(acf);
            console.log("acf parslangandan so'ng:", acf);
        } catch (e) {
            console.error("acf parslashda xatolik:", e);
        }
    }

    const [activeDirection, setActiveDirection] = useState('Farmatsiya');
    const [activeTab, setActiveTab] = useState('medical');
    ...
    const advantages = [
        ...
        },
        {
            ...
            description: 'Professional rahbarligida ta’lim olish',
            icon: <User size={24} />,
        },
        {
            title: 'Zamonaviy jihozlar',
            description: 'Ilg‘or texnologiyalarga kirish imkoniyati',
            icon: <Beaker size={24} />,
        },
        {
            title: 'Ishga joylashish kafolati',
            description: 'Karyera qurishda yordam',
            icon: <Award size={24} />,
        },
    ];
    ...
    useEffect(() => {
        console.log("Faol tab o'zgardi:", activeTab);
        ...
        if (activeTab === 'business' && acf && acf.accordion_repeater_2 && acf.accordion_repeater_2.length > 0) {
            console.log("Birinchi biznes yo'nalishi o'rnatilmoqda:", acf.accordion_repeater_2[0].accordion_title_uz);
        ...
        // Если таб "медицинский" и есть медицинские направления
            ...
            console.log("Birinchi tibbiy yo'nalish o'rnatilmoqda:", firstDirection);
            setActiveDirection(firstDirection);
        }
    }, [activeTab, directions, acf]);

    // Выбираем текущий контент для отображения в мед. разделе
    const currentDirection = directionContent[activeDirection] || directionContent['Farmatsiya'] || null;

    const tabs = [
        { id: 'medical', name: acf?.med_napravleniya_uz || 'Tibbiyot maktabi' },
        { id: 'business', name: acf?.business_napravleniya_uz || 'Biznes va ijtimoiy maktab' },
    ];
        ...
        <div className="bg-gray-50 min-h-screen font-sans">
            ...
            <div className="relative h-80 flex items-center justify-center overflow-hidden" style={{ background: `linear-gradient(rgba(99, 20, 99, 0.39), rgba(99, 20, 99, 0.66)), url('https://emuni.uz/wp-content/uploads/2022/07/pricing-hero.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <div className="text-center z-10 px-4 mb-10">
                    ...
                    <div className="w-24 h-1 bg-white mx-auto mb-6"></div>
                    <p className="text-xl text-white max-w-3xl">Biz bilan siz talab yuqori bo‘lgan kasb egasi bo‘lasiz va yetakchi klinikalar va tashkilotlarda amaliyot o‘taysiz</p>
                </div>
                <div className="absolute bottom-0 left-0 w-full overflow-hidden transform rotate-180">
                    <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="w-full h-12">
                        <path d="M0,0V46.29c47.79,22.2,103.59,32.17,158,28,70.36-5.37,136.33-33.31,206.8-37.5C438.64,32.43,512.34,53.67,583,72.05c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,104.45-29.34C989.49,25,1113-14.29,1200,52.47V0Z" fill="#f8f9fa" opacity=".8"></path>
            ...
            <div className="max-w-screen-xl mx-auto px-6 py-4">
                ...
                <div className="bg-white rounded-lg shadow-md p-8 mb-12 relative overflow-hidden">
                    ...
                    <p className="mb-4 text-lg leading-relaxed relative z-10">
                        Biz bilan siz talab yuqori bo‘lgan kasb egasi bo‘lasiz, poytaxtimizning yetakchi xususiy va davlat klinikalari va tashkilotlarida tajribali mutaxassislar rahbarligida amaliyot o‘taysiz, shuningdek{' '}
                        <span className="font-semibold" style={{ color: brandColor }}>Yevropa mamlakatlarining yetakchi tashkilotlari, klinikalari va oliygohlarida stajirovka qilasiz</span>*
                    </p>
                    <p className="mb-6 font-semibold text-sm bg-gray-100 p-4 rounded-lg border-l-4--" style={{ borderColor: brandColor }}>
                        * Akademik muvaffaqiyatning eng yuqori natijalariga ega talabalar muassasa qo‘llab-quvvatlash fondi hisobidan stajirovka o‘taydilar.
                    </p>
                    <p className="font-medium">O‘z imkoniyatingizni ro‘yobga chiqarish imkoniyatini qo‘ldan boy bermang, biz quyidagi bakalavriat yo‘nalishlari bo‘yicha qabulni ochamiz:</p>
                </div>
                            ...
                            <div className="py-2">
                                {activeTab === 'medical' ? (
                                    ...
                                    directions && Object.keys(directions).map((direction) => (
                                        ...
                                        >
                                            <div className="bg-[#7d3382] p-[7px] rounded-full mr-3">
                                                <Image src={directions[direction].title_icon} alt={`${direction} ikonasi`} width={20} height={20} className="" />
                                            </div>
                                            <span
                                    ...
                                    acf && acf.accordion_repeater_2 && acf.accordion_repeater_2.length > 0 ? acf.accordion_repeater_2.map((item, index) => (
                                        ...
                                        >
                                            {item.title_icon ? (
                                                <div className="bg-[#7d3382] p-[7px] rounded-full mr-3">
                                                    <Image src={item.title_icon} alt={`${item.accordion_title_uz} ikonasi`} width={20} height={20} className="" />
                                                </div>
                                            ) : (
                                            ...
                                            <span
                                                style={{ color: activeDirection === item.accordion_title_uz ? brandColor : '#333', fontWeight: activeDirection === item.accordion_title ? '500' : '400' }}
                                            >
                                                {item.accordion_title_uz}
                                            </span>
                                        </button>
                                    )) : (
                                        <div className="px-4 py- mavjud emas3 text-center text-gray-500">
                    ...
                    <div className="md:w-3/4">
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            >
                                ...
                                <p className="text-white text-opacity-80 relative z-10 max-w-2xl">EMU Universiteti bilan yuqori malakali mutaxassis bo‘ling!</p>
                            </div>
                            ...
                            <div className="p-8">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-bold mb-2" style={{ color: brandColor }}>Dastur ta’rifi</h3>

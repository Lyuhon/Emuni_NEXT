...
export default function Popup({ isOpen, onClose }) {
    ...
    const mappingMed = {
        ...
        'Детская терапевтическая стоматология': 'Детская терапевтическая стоматология | Болалар терапевтик стоматологияси',
        'Хирургическая стоматология': 'Хирургическая стоматология | Жарроҳлик стоматология',
        'Детская хирургическая стоматология': 'Детская хирургическая стоматология | Болалар жарроҳлик стоматологияси',
    };
    ...
    useEffect(() => {
        ...
        const ordinaturaField = fields.find(f => f.label === 'BITRIX - МАГИСТРАТУРА ');
        ...
        // Установка значения "МАГИСТРАТУРА" для поля BITRIX - МАГИСТРАТУРА
        if (ordinaturaField && !updatedFormData[ordinaturaField.id]) {
            updatedFormData[ordinaturaField.id] = 'МАГИСТРАТУРА';
            needUpdate = true;
        }
                ...
                >
                    ...
                    >
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-2xl font-bold text-gray-800">Магистратура EMU University</h2>

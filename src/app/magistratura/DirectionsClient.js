...
export default function DirectionsClient({ directions, directionContent, acf }) {
    ...
    return (
        <div className="bg-gray-50 min-h-screen font-sans">
            ...
            <div className="relative h-80 flex items-center justify-center overflow-hidden" style={{ background: `linear-gradient(rgba(99, 20, 99, 0.39), rgba(99, 20, 99, 0.66)), url('https://next.emu.web-perfomance.uz/wp-content/uploads/2025/04/magistratua-hero.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                ...
                <div className="text-center z-10 px-4 mb-10">
                    <h1 className="text-5xl font-bold text-white mb-4">Магистратура/Ординатура</h1>

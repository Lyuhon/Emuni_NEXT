        ...
        <div className="min-h-screen font-sans">
            ...
            >
                ...
                <div className="max-w-screen-xl container mx-auto px-4 flex flex-col md:flex-row items-center relative z-10">
                    ...
                    >
                        <div className="relative">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                                European Medical <br />
                                <span className="bg-gradient-to-r from-white to-[#f7eef7] bg-clip-text text-transparent">University</span> <br />
                                Pre-Foundation
                            </h1>
                        </div>
                        <p className="text-xl mb-8 opacity-90 max-w-lg">
                            Начните свой путь к высшему образованию с нашей инновационной подготовительной программой. Станьте частью сообщества будущих лидеров!
                        </p>
                    ...
                    >
                        ...
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full border-4 border-[#8a3c8a] rounded-lg -rotate-6 z-0"></div>
                    </motion.div>
                </div>
            ...
            >
                ...
                <div className="max-w-screen-xl container mx-auto relative z-10 px-2 md:px-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 md:gap-12 mb-10 md:mb-16 items-center">
                        ...
                        >
                            <div className="relative mx-auto max-w-md md:max-w-none">
                                ...
                                <div className="absolute top-4 md:top-6 -left-3 md:-left-6 p-3 md:p-6 bg-white shadow-lg rounded-lg z-20 max-w-[150px] md:max-w-xs transform rotate-3">
                    ...
                    >
                        <h3 className="text-xl md:text-3xl font-bold text-center mb-6 md:mb-10 text-[#631463]">Наши курсы</h3>
                    </motion.div>
                        ...
                        {[
                            ...
                            >
                                ...
                                <div className="p-4 md:p-6">
                                    <div className={`w-12 h-12 md:w-14 md:h-14 ${course.iconBg} rounded-lg mb-3 md:mb-4 flex items-center justify-center`}>
                                        <Image src={course.icon} alt={course.title} width={24} height={24} className="w-6 h-6 md:w-8 md:h-8" />
                                    </div>
                                    <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-3 text-gray-800">{course.title}</h3>
                                    <p className="text-xs md:text-sm text-gray-600 mb-4 md:mb-6">{course.description}</p>

...
//                                         {category.id === 'surgery' && 'Хирургические специальности и оперативные вмешательства'}
//                                         {category.id === 'pediatric' && 'Медицинское обслуживание детей и подростков'}
//                                         {category.id === 'therapeutic' && 'Терапевтические методы диагностики и лечения'}
//                                         {category.id === 'stomatology' && 'Стоматологические специальности и челюстно-лицевая хирургия'}
//                                     </p> */}
//                                 </button>
//                             ))}
//                         </div>
...
//                                                 <IconComponent className="w-6 h-6 text-[#6b0e55] transition-all duration-300 group-hover:scale-110" />
//                                             </div>
...
//                                         <div className="w-16 h-16 bg-white/20 rounded-2xl md:flex hidden items-center justify-center hover:scale-110 hover:rotate-12 transition-all duration-500">
//                                             {(() => {
...
//                                                                 {parseInt(selectedProgram.shift1Price).toLocaleString()} сум
//                                                             </div>
//                                                         </div>
//                                                         <div className="bg-gray-50 rounded-lg p-3">
//                                                             <span className="text-sm text-gray-600">2 смена:</span>
//                                                             <div className="font-semibold text-gray-900">
//                                                                 {parseInt(selectedProgram.shift2Price).toLocaleString()} сум
//                                                             </div>
//                                                         </div>
//                                                     </div> */}
//                                                 </div>
...
//                                         <div className="animate-slide-in-left-delayed">
//                                             <h3 className="text-lg font-bold text-gray-900 mt-4 mb-3">Описание программы</h3>
//                                             <div
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className={`transition-all duration-700 ease-in-out ${selectedProgram
                    ...
                    <div className="text-center">
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">Выберите направление</h2>
                                                        ...
                                                        <div className="grid grid-cols-2 gap-4">
                                                            <div>
                                                                ...
                                                                <div className="md:text-xl text-sx font-bold text-[#6b0e55]">
                                                                    {parseInt(selectedProgram.semesterPrice.replace(/\s/g, '')).toLocaleString()} <span className='text-sm md:md:text-xl'>сум</span>
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <span className="text-sm text-gray-600">За год:</span>
                                                                <div className="md:text-xl text-sx font-bold text-[#6b0e55]">
                                                                    {parseInt(selectedProgram.yearPrice.replace(/\s/g, '')).toLocaleString()} <span className='text-sm md:md:text-xl'>сум</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

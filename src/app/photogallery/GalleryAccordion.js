...
// export default function GalleryAccordion({ videos, gallerySections }) {
...
//                     <h1 className="text-5xl font-bold text-white mb-4">Фотогаллерея</h1>
...
//                         </div>
//                     ) : (
//                         <p className="text-center text-gray-500">Видеоматериалы отсутствуют или произошла ошибка загрузки.</p>
//                     )}
//                 </div>
...
//                                                 </h3>
//                                             </div>
//                                             {isActive ? <ChevronUp size={20} style={{ color: brandColor }} /> : <ChevronDown size={20} style={{ color: brandColor }} />}
//                                         </button>
...
//                             })
//                         ) : (
//                             <p className="text-center text-gray-500">Фотографии отсутствуют или произошла ошибка загрузки.</p>
//                         )}
//                     </div>
...
//                                                 width={gallerySections[activeAccordion].images[currentImageIndex].width}
//                                                 height={gallerySections[activeAccordion].images[currentImageIndex].height}
                ...
                <div className="mb-16">
                    ...
                    {videos.length > 0 ? (
                        ...
                        <p className="text-center text-gray-500">
                            Видеоматериалы отсутствуют или произошла ошибка загрузки.
                        </p>
                    )}
                </div>
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        {gallerySections.length > 0 ? (
                                                        ...
                                                        {section.images.map((image, imageIndex) => (
                                                            ...
                                                            >
                                                                <Image
                                                                    src={image.src}
                                                                    alt={image.alt}
                                                                    // width={image.width || 600} // Указываем ширину по умолчанию
                                                                    // height={image.height || 400} // Указываем высоту по умолчанию
                                                                    width='300'
                                                                    height='200' // Указываем высоту по умолчанию
                                                                    className="w-full h-auto object-cover"
                            ...
                            <p className="text-center text-gray-500">
                                Фотографии отсутствуют или произошла ошибка загрузки.
                            </p>
                        )}
                    </div>
                        ...
                        {lightboxOpen && gallerySections[activeAccordion]?.images && (
                            ...
                            >
                                ...
                                >
                                    <AnimatePresence initial={false} custom={direction}>
                                        ...
                                        >
                                            <Image
                                                ...
                                                // loading="eager" // Приоритетная загрузка в лайтбоксе
                                                // priority // Указываем приоритет для быстрой загрузки
                                                quality={20}
                                            />
                                        </motion.div>
                                    </AnimatePresence>
                                    <button
                                        // className="absolute top-4 right-4 text-white"
                                        className="absolute top-4 right-4 flex items-center justify-center w-10 h-10 rounded-full border-2 border-white bg-[#631463] text-white shadow-md transition-all duration-300 hover:bg-[#500f50] hover:scale-105"
                                        onClick={closeLightbox}
                                    >
                                        <X size={24} />
                                    </button>

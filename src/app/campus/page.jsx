...
// //             image: "https://emuni.uz/wp-content/uploads/2024/05/img_9853-2-min.jpg",
// //             subImages: [
...
// //                 "https://emuni.uz/wp-content/uploads/2024/05/img_9022-min.jpg",
// //             ],
// //             location: "Чиназский район, ул. Бузукур, 42-а",
// //             phone: "+998(78) 147-00-07",
// //             mapUrl: "https://www.google.com/maps?q=Chinaz,+Buzukur+St,+42-a",
// //         },
// //         {
// //             title: "Medical School Campus",
// //             image: "https://emuni.uz/wp-content/uploads/2024/05/black_cream_cutout_flowers_staff_wanted_sign_a2_landscape_poster-min.png",
// //             subImages: [
...
// //                 "https://emuni.uz/wp-content/uploads/2024/06/med-campus-nes-images-2.jpg",
// //             ],
// //             location: "улица Мухаммад 7/1, Ташкент, Узбекистан",
// //             phone: "+998(78) 147-00-07",
...
// //                     >
// //                         <img
// //                             src={campuses[currentSlide].image}
// //                             alt={campuses[currentSlide].title}
// //                             className="w-full h-[500px] object-cover"
// //                         />
// //                         <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
// //                         <div className="absolute bottom-4 left-4 text-white">
// //                             <h2 className="text-2xl font-bold">{campuses[currentSlide].title}</h2>
// //                         </div>
// //                     </div>
...
// //                     >
// //                         <ChevronLeft className="w-6 h-6 text-[#5f1464]" />
// //                     </button>
// //                     <button
// //                         onClick={handleNext}
...
// //                                     className={`w-3 h-3 rounded-full ${currentSlide === index ? "bg-[#5f1464]" : "bg-gray-400"}`}
// //                                 />
// //                             ))}
// //                         </div>
...
// //                             <img
// //                                 src={campuses[(currentSlide + 1) % campuses.length].image}
// //                                 alt={`Preview of ${campuses[(currentSlide + 1) % campuses.length].title}`}
...
// //                         <h3 className="text-xl font-bold text-[#5f1464] mb-4">
// //                             {campuses[0].title}
// //                         </h3>
...
// //                             <a href={`tel:${campuses[0].phone}`} className="text-[#5f1464] hover:underline">
// //                                 {campuses[0].phone}
// //                             </a>
// //                         </p>
// //                         <a
// //                             href={campuses[0].mapUrl}
// //                             target="_blank"
// //                             rel="noopener noreferrer"
// //                             className="mt-4 inline-block text-[#5f1464] hover:underline"
// //                         >
// //                             <img
// //                                 src={`https://maps.googleapis.com/maps/api/staticmap?center=${encodeURIComponent(campuses[0].location)}&zoom=14&size=400x200&markers=color:red|${encodeURIComponent(campuses[0].location)}&key=YOUR_GOOGLE_MAPS_API_KEY`}
// //                                 alt="Map for Business Campus"
...
// //                         </p>
// //                         <p className="text-gray-700 mt-2">
// //                             <a href={`tel:${campuses[1].phone}`} className="text-[#5f1464] hover:underline">
// //                                 {campuses[1].phone}
// //                             </a>
// //                         </p>
// //                         <a
// //                             href={campuses[1].mapUrl}
// //                             target="_blank"
// //                             rel="noopener noreferrer"
// //                             className="mt-4 inline-block text-[#5f1464] hover:underline"
// //                         >
// //                             <img
// //                                 src={`https://maps.googleapis.com/maps/api/staticmap?center=${encodeURIComponent(campuses[1].location)}&zoom=14&size=400x200&markers=color:red|${encodeURIComponent(campuses[1].location)}&key=YOUR_GOOGLE_MAPS_API_KEY`}
// //                                 alt="Map for Medical Campus"
// //                                 className="w-full h-48 rounded-lg shadow-md"
// //                             />
// //                         </a>
// //                     </div>
...
// //             phone: "+998(78) 147-00-07",
// //             mapUrl:
// //                 "https://www.google.com/maps?q=Chinaz,+Buzukur+St,+42-a",
// //         },
// //         {
// //             title: "Medical School Campus",
// //             images: [
...
// //             phone: "+998(78) 147-00-07",
// //             mapUrl:
// //                 "https://www.google.com/maps?q=Muhammad+St+7/1,+Tashkent",
// //         },
// //     ];
...
// //         customPaging: (i) => (
// //             <button
// //                 className={`w-2 h-2 rounded-full ${i === 0 ? "bg-[#5f1464]" : "bg-gray-400 opacity-50"}`}
// //             />
// //         ),
// //     };
...
// //                             <Slider {...sliderSettings} prevArrow={<CustomPrevArrow />} nextArrow={<CustomNextArrow />}>
...
// //                 // background: #5f1464 !important; /* Активная точка пурпурная */
// //                 // }
// //             `}</style>
// //         </div>
// //     );
...
//         ),
//         customPaging: (i, campusIndex) => (
//             <button
//                 className="w-16 h-12 overflow-hidden rounded-lg cursor-pointer transition-all duration-300 hover:shadow-md"
//                 onClick={() => handleBulletClick(campusIndex, i)}
//             >
//                 <img

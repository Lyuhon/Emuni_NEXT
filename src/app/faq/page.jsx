...
export const metadata = {
    title: "Часто задаваемые вопросы - EMU University",
    description: "Получите ответы на часто задаваемые вопросы о поступлении, программах обучения, стоимости и перспективах выпускников EMU University в Ташкенте.",
    keywords: "FAQ EMU University, вопросы об университете, поступление в EMU, образование в Ташкенте, вопросы и ответы EMU",
    openGraph: {
        title: "Часто задаваемые вопросы - EMU University",
        description: "Ответы на самые популярные вопросы о поступлении, обучении и перспективах в EMU University",
            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-8 md:py-12 border-t border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <a href="/contacts" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition-all">
                        <h3 className="font-semibold text-[#6b0e55] mb-2">Связаться с нами</h3>
                        <p className="text-gray-600 text-sm">Остались вопросы? Свяжитесь с приемной комиссией EMU University</p>
                    </a>
                </div>
            </div>
        </div>

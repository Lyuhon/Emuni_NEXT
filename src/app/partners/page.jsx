                    ...
                    >
                        {partnersData.map((slideItem, slideIndex) => (
                            <SwiperSlide key={slideIndex}>
                                <div className="partners-card bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                                    <div className="p-6">
                                        <div className="grid grid-cols-1 gap-4 md:gap-6">
                                            ...
                                            {slideItem.partner_1 && (
                                                <a
                                                    ...
                                                    className="partner-item flex flex-col items-center mb-4 md:mb-6 transition-transform duration-300 hover:scale-105"
                                            ...
                                            {slideItem.partner_3 && (
                                                <a
                                                    ...
                                                    className="partner-item flex flex-col items-center transition-transform duration-300 hover:scale-105"

        ...
        <section ref={sectionRef} className="relative w-full min-h-[90vh] overflow-hidden bg-[#f7f7f7]">
            ...
            <div className="max-w-screen-xl mx-auto px-4 py-12 md:py-20 flex items-center min-h-[90vh]">
                <motion.div
                    ...
                    className="w-full md:w-5/12 bg-white/95 rounded-xl p-8 md:p-12 shadow-2xl z-10"
                >
                    <motion.h2
                        ...
                        className="text-3xl md:text-5xl font-bold text-[#631463] mb-6"
                    >
                    ...
                    <motion.p
                        ...
                        className="text-lg md:text-xl text-[#631463] mb-6 leading-relaxed"
                    >
                    ...
                    <motion.div
                        ...
                        className="mb-8 space-y-4 text-[#631463]/90"
                    >
                        <p>
                    ...
                    >
                        ...
                        <p className="text-[#8a3c8a] text-base md:text-lg">Founder / CEO EMU University</p>
                    </motion.div>

...
//                                 {activeTab === 'medical'
//                                     ? renderBadges(currentDirection)
//                                     : renderBadges(currentBusinessDirection)
//                                 }

//                                 {/* Инфо-карточки для 1 смены */}
...
//                                 {activeTab === 'medical' && renderPrices2Smena(currentDirection)}
//                                 {activeTab === 'business' && renderPrices2Smena(currentBusinessDirection)}

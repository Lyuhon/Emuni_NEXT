...
//                 <div className="absolute top-20 right-20 w-96 h-96 bg-[#f9eef5] rounded-full mix-blend-multiply blur-xl opacity-70 animate-pulse" />
//                 <div className="absolute top-40 right-40 w-72 h-72 bg-[#8f3178] rounded-full mix-blend-multiply blur-xl opacity-50 animate-pulse [animation-delay:700ms]" />
...
//             {/* Main Content */}
//             <div className="min-h-[93vh] flex justify-center items-center relative z-10">
//                 <div className="p-5 sm:p-7 md:p-10 md:pt-2 md:pb-16 text-center max-w-[300px] xs:max-w-[350px] sm:max-w-[478px] flex flex-col items-center">
//                     {/* Heart Icon */}
...
//                         Наши операторы свяжутся с вами в ближайшее время по номеру <br />
//                         <a className="underline text-[#6b0e55] hover:text-[#8f3178]" href="tel:+998787777774">
//                             +998(78) 147-00-07
//                         </a>
...
//                         <span className="font-semibold text-[#6b0e55]">8.5</span> по IELTS и заработать{' '}
//                         <span className="font-semibold text-[#6b0e55]">$1000 cashback</span>, обучаясь в Cambridge!
//                     </p> */}

//                     {/* Telegram Button */}
//                     <a
//                         target="_blank"
//                         href="https://t.me/+y-WQXQAbGbw1NjA6"
...
//                             />
//                         </svg>
//                         <div className="pl-4 flex items-center md:flex-col md:items-start md:gap-0 gap-2">
//                             <p className="font-medium text-lg md:text-xl text-left md:whitespace-nowrap">
//                                 Не забудьте следить за нашим Telegram
//                             </p>
//                             <p className="text-base md:text-lg flex items-center gap-1">
//                                 <span className="opacity-70 hidden md:block">Присоединяйтесь к Telegram</span>

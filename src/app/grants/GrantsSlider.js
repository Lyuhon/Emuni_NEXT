    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setHeaderInfo({
                    title: textInfo.zagolovok_ru || "Гранты и финансирование",
                    description: textInfo.opisanie_ru || "Университет EMU выделил 5 200 000 000 сумов в виде грантов на 2025-2026 учебный год",
                    grantsCount: textInfo.kolvo_grantoderzhatelej_ru || "200+ учредителей-грантодержателей"
                });
                ...
                const processedGrants = grantsData
                    ...
                    .map((grant, index) => ({
                        id: index + 1,
                        name: grant.imya_ru || '',
                        direction: grant.napravlenie_ru || '',

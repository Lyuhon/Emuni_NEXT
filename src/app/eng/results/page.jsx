...
export const metadata = {
    title: "Exam Results - EMU University",
    description: "View the results of entrance exams at EMU University",
    keywords: "EMU exam results, EMU University entrance exams, EMU admission results, exams in Tashkent",
    openGraph: {
        title: "Exam Results - EMU University",
        description: "Official results of entrance exams at EMU University",
...
export default async function ExamResultsPage() {
    ...
    // Publication date
    const publicationDate = "15 july 2025";
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                ...
                <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-12 md:py-24">
                    <div className="relative z-10 w-full text-center">
                        ...
                        <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-4">
                            Official results of entrance exams at EMU University
                        </p>
                        <div className="inline-flex items-center px-4 py-2 bg-[#6b0e55]/10 rounded-full text-[#6b0e55] font-medium">
                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 01-2 2v12a2 2 0 002 2z"></path>
                            </svg>
            ...
            {/* Results Section */}
            <div className="max-w-screen-xl- max-w-[900px] mx-auto px-4 md:px-8 py-12 md:py-16">
                {/* Info Banner */}
                <div className="mb-8 p-6 bg-white border-l-4 border-[#6b0e55] rounded-lg shadow-sm">
                    <h2 className="text-xl font-bold text-[#6b0e55] mb-4">Important Information</h2>
                    <div className="text-gray-900 space-y-2">
                        <p>
                            <strong>Official Results:</strong> All documents presented are official results of entrance exams at EMU University.
                        </p>
                        <p>
                            <strong>Document Search:</strong> Use Ctrl+F to quickly search for your results by last name or number.
                        </p>
                        <p>
                            <strong>Questions:</strong> For all questions regarding results, please contact the EMU University admissions office.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 md:gap-8">
                    {subjects.length > 0 ? (
                        ...
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-600">Exam results are temporarily unavailable. Please try again later.</p>
                        </div>
                    )}
                </div>
            </div>
            ...
            {/* Contact Information */}
            <div className="max-w-screen-xl- max-w-[900px] mx-auto px-4 md:px-8 py-8 md:py-12 border-t border-gray-200">
                <h2 className="text-2xl font-bold text-[#6b0e55] mb-6">Still have questions?</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <a href="/contacts" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition-all">
                        <h3 className="font-semibold text-[#6b0e55] mb-2">Admissions Office</h3>
                        <p className="text-gray-600 text-sm">Contact us for additional information</p>
                    </a>
                    <a href="/faq" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition-all">
                        <h3 className="font-semibold text-[#6b0e55] mb-2">Frequently Asked Questions</h3>
                        <p className="text-gray-600 text-sm">Answers to popular questions about admission and study</p>
                    </a>
                    <a href="https://apply.emuni.uz/" className="p-4 bg-white rounded-lg shadow hover:shadow-md transition-all">
                        <h3 className="font-semibold text-[#6b0e55] mb-2">Document Submission</h3>
                        <p className="text-gray-600 text-sm">Online application for admission to EMU University</p>
                    </a>
                </div>
            </div>
            ...
            <script type="application/ld+json" dangerouslySetInnerHTML={{
                __html: JSON.stringify({
                    ...
                    "@type": "WebPage",
                    "name": "Exam Results - EMU University",
                    "description": "Official results of entrance exams at EMU University with search capability",
                    "publisher": {
                        "@type": "Organization",
                        "name": "EMU University"
                    },
                    ...
                    "about": subjects.map(subject => ({
                        ...
                        "name": subject.nameEng || subject.nameRu
                    }))
                })
            }} />
        </div>

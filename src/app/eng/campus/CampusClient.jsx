        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white relative overflow-hidden py-16 md:py-24">
                <div className="absolute inset-0">
                    <div className="absolute -top-20 right-20 w-96 h-96 bg-pink-100 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-pulse" style={{ backgroundColor: `${brandColorLighter}` }} />
                    <div className="absolute top-40 -left-20 w-72 h-72 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-60 animate-pulse delay-700" style={{ backgroundColor: `${brandColorLight}40` }} />
                </div>

                <div className="max-w-5xl mx-auto px-4 md:px-8 relative z-10">
                    <div className="text-center mb-8">
                        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                            Our <span style={{ color: brandColor }}>campuses</span>
                        </h1>
                        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
                            Modern educational spaces designed for comfortable learning and comprehensive student development
                        </p>
                    </div>

                    {/* Tabs for switching between campuses */}
            ...
            {/* Main Content with unified vertical structure */}
            <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-12 -mt-8">
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    <div className="md:flex">
                        {/* Left column - slider takes 60% width on desktop */}
                        ...
                        {/* Right column - information takes 40% width on desktop */}

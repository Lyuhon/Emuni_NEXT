        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="relative h-80 flex items-center justify-center overflow-hidden" style={{
                ...
                <div className="text-center z-10 px-4">
                    <h1 className="text-5xl font-bold text-white mb-4">EMU Support Fund</h1>
                    <div className="w-24 h-1 bg-white mx-auto mb-6"></div>
                    <p className="text-xl text-white max-w-3xl">
                        Supporting young and promising students
                    </p>
                </div>
            ...
            <div className="max-w-screen-xl mx-auto px-6 py-12">
                ...
                >
                    ...
                    <h2 className="text-3xl font-bold text-center mb-8" style={{ color: brandColor }}>
                        EMU University's founders have established a SUPPORT FUND<br />
                        FOR YOUNG AND PROMISING STUDENTS
                    </h2>

                    <div className="flex justify-center mb-10">
                        <Image
                            src="https://next.emu.web-perfomance.uz/wp-content/uploads/2025/05/grants_eng.webp" // Replace with the actual image URL
                            alt="EMU Support Fund logo"
                            width={1200}
                            height={800}
                    ...
                    <div className="p-5 bg-purple-50 rounded-lg mb-8 border-l-4" style={{ borderColor: brandColor }}>
                        <p className="mb-3">
                            * According to the University's internal policy, every student admitted on a contract basis has a chance to receive a founder's grant for free education for one semester based on the average academic performance indicators of each semester and active participation in University life. Additional points are added to the student's final average score for:
                        </p>
                        <ul className="space-y-3 mb-6 ml-6">
                            <li className="flex items-start">
                                <CheckCircle size={18} className="mr-2 mt-1 flex-shrink-0" style={{ color: brandColor }} />
                                <p>participation in conferences and giving presentations;</p>
                            </li>
                            <li className="flex items-start">
                                <CheckCircle size={18} className="mr-2 mt-1 flex-shrink-0" style={{ color: brandColor }} />
                                <p>participation and victories in olympiads;</p>
                            </li>
                            <li className="flex items-start">
                                <CheckCircle size={18} className="mr-2 mt-1 flex-shrink-0" style={{ color: brandColor }} />
                                <p>innovation proposals in both theoretical and practical fields;</p>
                            </li>
                            <li className="flex items-start">
                                <CheckCircle size={18} className="mr-2 mt-1 flex-shrink-0" style={{ color: brandColor }} />
                                <p>development and implementation of innovative solutions;</p>
                            </li>
                            <li className="flex items-start">
                                <CheckCircle size={18} className="mr-2 mt-1 flex-shrink-0" style={{ color: brandColor }} />
                                <p>development and implementation of startups, winning places in competitions.</p>
                            </li>
                        </ul>
                        <p>
                            ** The Fund covers 25%, 50%, 75%, or 100% of expenses depending on how well students fulfill the requirements and tasks set before them.
                        </p>
                    </div>
                </motion.div>

            ...
            <div className="max-w-screen-xl container mx-auto relative z-10 px-4">
                ...
                >
                    ...
                    <p className="text-sm md:text-base mt-2 opacity-80">
                        EMU University – your path to success
                    </p>
                </motion.div>
                    ...
                    >
                        <div className="relative pl-4 md:pl-8">
                            ...
                            <p className="text-sm md:text-base text-gray-600 mb-4">
                                Since 2020, EMU University has been a leader in medical education. We have been awarded <span className="text-[#ddb74b] font-semibold">"Best Medical University 2024"</span> and <span className="text-[#ddb74b] font-semibold">"Best Non-Government University".</span>
                            </p>
                            <div className="space-y-3 text-sm md:text-base text-gray-600">
                                <div className="flex items-start">
                                    ...
                                    <p>International programs and partnerships with leading universities.</p>
                                </div>
                                <div className="flex items-start">
                                    <svg className="w-5 h-5 text-[#8f3178] mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <p>Modern campuses with advanced laboratories.</p>
                                </div>
                                <div className="flex items-start">
                                    <svg className="w-5 h-5 text-[#8f3178] mr-2 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <p>Career prospects in the global industry.</p>
                                </div>
                            </div>
                            <motion.div
                                initial={{ width: 0 }}
                            ...
                            <p className="text-xs md:text-sm text-gray-500 mt-2">Students: 2500+ and growing!</p>
                        </div>
                    </motion.div>

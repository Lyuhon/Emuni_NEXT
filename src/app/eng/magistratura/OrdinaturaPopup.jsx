...
//         'Хирургия (по направлениям)': 'Хирургия (по направлениям) | Хирургия (йўналишлари бўйича)',
//         'Урология': 'Урология',
//         'Медицинская радиология': 'Медицинская радиология | Тиббий радиология',
//         'Педиатрия (по направлениям)': 'Педиатрия (по направлениям) | Педиатрия (йўналишлари бўйича)',
//         'Дентальная имплантология': 'Дентальная имплантология | Дентал имплантология',
//         'Ортопедическая стоматология': 'Ортопедическая стоматология | Ортопедик стоматология',
//         'Терапевтическая стоматология': 'Терапевтическая стоматология | Терапевтик стоматология'
//     };
...
//         const facultyField = fields.find(f => f.label === 'Выберите факультет');
...
//         const langField = fields.find(f => f.label === 'Язык обучения');
...
//             if (mappedValue) {
//                 if (ordinaturaField && formData[ordinaturaField.id] !== selectedValue) {
//                     updatedFormData[ordinaturaField.id] = selectedValue;
//                     needUpdate = true;
//                 }
...
//                             <h2 className="text-2xl font-bold text-gray-800">Ориданутра EMU University</h2>
        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    >
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-2xl font-bold text-gray-800">Ординатура EMU University</h2>

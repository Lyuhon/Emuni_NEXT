...
export async function generateMetadata({ params }) {
    ...
    const title = acfFields.zagolovok_ang || pageData.title?.rendered || 'Страница';
    const description = acfFields.kratkoe_opisanie_ang || '';
    ...
    return {
        ...
        description: description || 'EMU University - a leading medical university',
        keywords: `${title}, EMU University, medical university`,
        openGraph: {
            title: `${title} - EMU University`,
            description: description || 'EMU University - a leading medical university',
            images: [image],
...
export default async function DynamicPage({ params }) {
    ...
    const title = acfFields.zagolovok_ang || pageData.title?.rendered || 'Страница';
    const shortDescription = acfFields.kratkoe_opisanie_ang || '';
    const heroBanner = acfFields.fonovoe_izobrazhenie?.url || null;
    const content = cleanContent(acfFields.kontent_straniczy_ang) || cleanContent(pageData.content?.rendered) || '';

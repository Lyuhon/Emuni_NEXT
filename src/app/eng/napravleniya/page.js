...
async function fetchDirections() {
    ...
    if (data.acf.accordion_repeater) {
        data.acf.accordion_repeater.forEach((item) => {
            ...
            directionContent[title] = {
                ...
                description: item.text_eng || 'Описание отсутствует.',
                ...
                semester_price_2_smena: item.semester_price_2_smena || 'Not specified',
                full_price_2_smena: item.full_price_2_smena || 'Not specified',
    ...
    const tarifImages = {
        medical: data.acf.tarifnaya_setka?.med_napravleniya_eng?.url || null,
        business: data.acf.tarifnaya_setka?.biznes_napravleniya_eng?.url || null
    };

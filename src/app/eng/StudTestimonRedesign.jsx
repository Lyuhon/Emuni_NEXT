...
const TestimonialSlider = () => {
            ...
            try {
                ...
                if (data && data.acf && data.acf.otzyv && Array.isArray(data.acf.otzyv)) {
                    const formattedTestimonials = data.acf.otzyv.map((item, index) => ({
                        id: index + 1,
                        name: item.fio_eng || '',
                        program: item.fakultet_eng || '',
                        testimonial: item.otzyv_studenta_eng || '',
                        image: item.izobrazhenie?.url || '/api/placeholder/400/500',
                        year: item.podpis_year_eng || '',
                        achievement: ''
                    }));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Here you can add a real API call to submit the review
        ...
        return (
            <section>
                <div className="relative max-w-5xl mx-auto pt-12 pb-6 px-3 bg-[#FFFFFF] text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#6b0e55] mb-4">Loading testimonials...</h2>
    ...
    if (error) {
        return (
            <section>
                <div className="relative max-w-5xl mx-auto pt-12 pb-6 px-3 bg-[#FFFFFF] text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#6b0e55] mb-4">Error loading testimonials</h2>
                    <div className="w-24 h-1 bg-[#6b0e55] mx-auto mb-6"></div>
                    <p className="text-gray-700">An error occurred while loading testimonials. Please try again later.</p>
                </div>
            </section>
        );
    }
    ...
    if (testimonials.length === 0) {
        return (
            <section>
                <div className="relative max-w-5xl mx-auto pt-12 pb-6 px-3 bg-[#FFFFFF] text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-[#000] mb-4">Student Testimonials</h2>
                    <div className="w-24 h-1 bg-[#6b0e55] mx-auto mb-6"></div>
                    <p className="text-gray-700">There are currently no testimonials available.</p>
                    <motion.button
                                    ...
                                    <div className="flex flex-col space-y-4">
                                        <div className="flex flex-wrap items-center gap-3 md:gap-4">
                                            <div className="bg-gray-100 rounded-full px-3 md:px-4 py-1 md:py-2 flex items-center">
                                                ...
                                                <span className="text-xs md:text-sm text-gray-700">Recommends university</span>
                                            </div>
                                            <div className="bg-gray-100 rounded-full px-3 md:px-4 py-1 md:py-2 flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 md:h-5 md:w-5 text-[#6b0e55] mr-1 md:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                                                </svg>
                                                <span className="text-xs md:text-sm text-gray-700">Active participant in student life</span>
                                            </div>
                                        </div>

                                        {/* "Leave a review" button inside each slide */}
                                        <motion.button
                            ...
                            >
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {errors.phone && (
                                            <p className="text-red-500 text-sm animate-pulse">
                                                Please enter a phone number in the format (99)999-99-99.
                                            </p>
                                        )}
                                    </div>
                                    <div className="space-y-2">

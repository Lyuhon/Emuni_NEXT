    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-start justify-center">
                <h3 className="text-3xl md:text-4xl font-bold text-[#6B0E55] mb-1 flex items-center">
...
const Stats = () => {
    return (
        <section className="pt-20 pb-8 px-4 relative overflow-hidden">
            ...
            {/* Decorative elements */}
            <div className="absolute top-20 right-10 w-24 h-24 rounded-full bg-[#6B0E55] opacity-5"></div>
            <div className="absolute bottom-20 left-10 w-32 h-32 rounded-full bg-[#6B0E55] opacity-5"></div>
            ...
            <div className="max-w-screen-xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-16 mb-16">
                    ...
                    >
                        <span className="text-[#6B0E55] font-semibold mb-3 uppercase tracking-wider text-sm">EMU University Statistics</span>
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 leading-tight mb-8">
                            Academic<br />excellence with<br />
                            <span className="text-[#6B0E55]">global perspective</span>
                        </h2>
                    ...
                    >
                        ...
                        <Counter
                            target="51"
                            suffix="%"
                            title="Faculty with advanced academic degrees"
                            icon={
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#6B0E55]" fill="none" viewBox="0 0 24 24" stroke="currentColor">

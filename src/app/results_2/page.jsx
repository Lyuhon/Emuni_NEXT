...
// app/rezultaty-ekzamenov/page.jsx
import React from "react";
import ExamResultsItemPDFJS from "./ExamResultsItem"; // Обновленный импорт
            ...
            <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-12 md:py-16">
                ...
                <div className="mb-8 p-6 bg-white border-l-4 border-[#6b0e55] rounded-lg shadow-sm">
                    ...
                    <div className="text-gray-900 space-y-2">
                        ...
                        <p>
                            <strong>Поиск по документу:</strong> Используйте функцию поиска в браузере (Ctrl+F) или скачайте PDF для поиска своих результатов.
                        </p>
                        <p>
                            <strong>Навигация:</strong> Используйте кнопки навигации для перехода между страницами и изменения масштаба документа.
                        </p>
                        <p>
                            <strong>Вопросы:</strong> По всем вопросам касательно результатов обращайтесь в приемную комиссию EMU University.
                        </p>

...
export async function generateMetadata({ params }) {
    ...
    const title = acfFields.zagolovok || pageData.title?.rendered || 'Страница';
    const description = acfFields.kratkoe_opisanie || '';
    ...
    return {
        ...
        description: description || 'EMU University - ведущий медицинский университет',
        keywords: `${title}, EMU University, медицинский университет`,
        openGraph: {
            title: `${title} - EMU University`,
            description: description || 'EMU University - ведущий медицинский университет',
            images: [image],
...
export default async function DynamicPage({ params }) {
    ...
    const title = acfFields.zagolovok || pageData.title?.rendered || 'Страница';
    const shortDescription = acfFields.kratkoe_opisanie || '';
    const heroBanner = acfFields.fonovoe_izobrazhenie?.url || null;
    const content = cleanContent(acfFields.kontent_straniczy) || cleanContent(pageData.content?.rendered) || '';

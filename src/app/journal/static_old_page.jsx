...
// import { Book, BookOpen, Download, FileText, Users, ChevronRight, Menu, Images } from 'lucide-react';
// import './journal.css'; // Предполагаю, что стили будут в отдельном файле
...
//     const title = acf.zagolovok_straniczy_ru;
...
//         number: journal.nazvanie_ru.match(/№(\d+)/)?.[1] || 'Unknown', // Извлекаем номер из названия
//         year: journal.god,
...
//                                             className="flex items-center space-x-2 bg-white/20 backdrop-blur-sm px-3 md:px-4 py-1.5 md:py-2 rounded-full hover:bg-white/30 transition-colors duration-200"
//                                             target="_blank"

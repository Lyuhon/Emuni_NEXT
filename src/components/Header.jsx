...
export default function Header() {
    ...
    const menuItems = [
        // { name: "Общая информация", href: "/about" },
        // { name: "Приём 24-25", href: "/admission" },
        // { name: "Техникум EMU", href: "/tech" },
        ...
        <header className="fixed top-0 w-full bg-[#5f1464] z-[1000] shadow-md">
            <div className="max-w-screen-xl mx-auto px-4 py-[40px] md:px-8 h-16 flex items-center justify-between">
                ...
                <Link href="/">
                    <div className="flex items-center">
                        <img
                            ...
                            width={140} // Увеличил ширину для длинного логотипа
                            height={50}
                ...
                <div className="flex items-center space-x-4">
                    {/* Registration Button */}
                    <button className="hidden md:block px-4 py-2 bg-white text-[#5f1464] rounded-full text-sm font-medium hover:bg-gray-100 transition-colors">
                        Регистрация
                    </button>

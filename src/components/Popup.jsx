...
//     // И обновите useEffect для синхронизации полей:
...
//             }
//         }
//     }, [formData[fields.find(f => f.label === 'Выберите направление')?.id], fields.length]);
...
export default function Popup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // // Редирект с уведомлением и таймаутом
            // if (res.ok) {
            //     setIsSubmitted(true);
            //     setFormData({});
            //     setErrors({});
            ...
            //     // Добавляем редирект через 1.5 секунды
            //     setTimeout(() => {
            //         setIsOpen(false); // Закрываем попап перед редиректом
